 ...
 */
final class Version20220530224232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plats DROP categories_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plats ADD categories_id INT NOT NULL');
    }
}
